...
var file_app_dispatcher_config_proto_goTypes = []any{
	(*SessionConfig)(nil), // 0: xmplus.app.dispatcher.SessionConfig
	(*Config)(nil),        // 1: xmplus.app.dispatcher.Config
}
var file_app_dispatcher_config_proto_depIdxs = []int32{
	0, // 0: xmplus.app.dispatcher.Config.settings:type_name -> xmplus.app.dispatcher.SessionConfig
