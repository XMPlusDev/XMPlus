...
install_XMPlus() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XMPlus/XMPlus-linux.zip https://github.com/XMPlusDev/XMPlus/releases/download/${last_version}/XMPlus-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/XMPlusDev/XMPlus/releases/download/${last_version}/XMPlus-linux-${arch}.zip"
